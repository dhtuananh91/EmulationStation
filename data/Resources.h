...
extern const size_t background_png_size;
extern const unsigned char background_png_data[];
...
extern const size_t splash_png_size;
extern const unsigned char splash_png_data[];
